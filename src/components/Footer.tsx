      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-3">
        <div>
          ...
          <p className="mt-4 max-w-xs text-sm text-background/70">
            Your Trusted Travel Partner Across Assam. Safe rides, comfortable journeys, affordable
          ...
          <div className="mt-5 flex gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-full bg-whatsapp p-2.5 text-white transition hover:scale-110"
              aria-label="WhatsApp"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-full bg-background/10 p-2.5 text-background transition hover:bg-gradient-fire hover:text-ink"
            ...
            <a
              href={`tel:+${WA_NUMBER}`}
              className="rounded-full bg-background/10 p-2.5 text-background transition hover:bg-gold hover:text-ink"
              aria-label="Call"
            >
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-background/80">
            <li className="flex gap-3">
              <Phone className="h-4 w-4 mt-0.5 shrink-0 text-ember" />
              <a href={`tel:+${WA_NUMBER}`} className="hover:text-gold">
                {PHONE_DISPLAY}
              </a>
            </li>
            <li className="flex gap-3">
              <Mail className="h-4 w-4 mt-0.5 shrink-0 text-ember" />
              <a href={`mailto:${EMAIL}`} className="hover:text-gold break-all">
                {EMAIL}
              </a>
            </li>
            <li className="flex gap-3">
              <MapPin className="h-4 w-4 mt-0.5 shrink-0 text-ember" />
              <span>{ADDRESS}</span>
            </li>
          </ul>
        </div>
